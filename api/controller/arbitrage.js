...
`);
  ...
  sandwichtxs = sandwichedTransaction.rows.map((d) => {
    ...
    obj.contract_address = d.minerpayments.miner_payments_front.transaction_to_address;
    obj.transaction_hash =  d.transaction_hash;
    obj.protocols = [d.protocol];
    obj.transfers = [{token_address:d.token_in_address},{token_address:d.token_out_address}];
    obj.block_number = d.block_number;
    obj.profit_token_address = d.profit_token_address;
    obj.gas_cost = (((d.minerpayments.miner_payments_front.gas_used  * d.minerpayments.miner_payments_front.gas_price) / 1e18)+
    ((d.minerpayments.miner_payments_back.gas_used  * d.minerpayments.miner_payments_back.gas_price) / 1e18)) * prices[wbnb];
    obj.profit_usd = d.profit_amount * prices[d.profit_token_address];
    obj.type ="Sandwich"
    return obj;
  });
